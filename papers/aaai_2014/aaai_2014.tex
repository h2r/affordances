...
RTDP &  \texttt{Vanilla}  			&	27439($\pm$2348)	&	-22.6($\pm$9)	&	\bf{107}($\pm$33)		\\
 & \texttt{w/ Opt}  				&	\bf{26663}($\pm$2298)	&	-17.4($\pm$4.0)	&	129($\pm$35)		\\
 &\texttt{w/ MA}  				&	31083($\pm$2468)	&	-21.7	($\pm$5.0)	&	336($\pm$28)		\\
 &\texttt{w/ MA+Opt}  			&	27143($\pm$2380)	&	\bf{-16.9}($\pm$3.0)	&	323($\pm$38)		\\ \hline
 Affordance-Aware &\texttt{Vanilla}  	& 	9935($\pm$1031)&	-12.4($\pm$1.0)	&	\bf{53}($\pm$5.0)		\\
  &\texttt{w/ Opt}  				& 	\bf{9675}($\pm$953)	&	\bf{-11.5}($\pm$1.0)	&	93($\pm$10)		\\
