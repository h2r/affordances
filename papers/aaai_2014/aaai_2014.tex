...
\pdfinfo{
   /Author (David Abel , Ellis Herskowitz, Gabriel Barth-Maron, James MacGlashan, Stefanie Tellex)
...
% Author info:
\author{\authorblockN{David Abel, Ellis Herskowitz, Gabriel Barth-Maron, James MacGlashan, Stefanie Tellex}
