...
task. To avoid applying irrelevant actions, we formalize the notion of {\em affordances} as
...
agent and its capabilities.  Affordances focus an agent's attention on
...
this method is denoted as \texttt{ERTDP}, for Expert
...
\begin{figure*}
\centering
\includegraphics[scale=0.08,width=\textwidth]{figures/average_results.png}%
...
features that mirrored the agent's actual state space. We
...
\texttt{LRTDP} 			& 	{\bf 9935} ($\pm$1031)	&	{\bf -12.4} ($\pm$1.0)& {\bf 53} ($\pm$5) \\ \hline
