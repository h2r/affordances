...
Figure~\ref{fig:minecraft} shows three examples scenes from Minecraft
...
RTDP (e.g. the mining task). This is due to the fact that LA-RTDP
...
to dynamically adjusting the threshold based on planning feedback. Additionally, RTDP occasionally achieved a faster clock time because EA-RTDP and LA-RTDP also evaluate the affordance predicates in every state, adding a small amount of time to planning.
