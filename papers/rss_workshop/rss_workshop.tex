...
\gnote{I took out the paragraph on increasing planning time. We mention it in the intro and I've moved the citation to below}
...
%of even a small subset of unhelpful options can negatively impact planning/learning time
