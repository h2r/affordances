...
def write_results_to_file(merged_results, map_counter):
	...
	for map_type in merged_results:
		...
		for planner in merged_results[map_type]:
			...
			print "num_trials", map_counter[map_type]
			outfile.write(str(merged_results[map_type][planner][0] / map_counter[map_type]) + ",")
			outfile.write(str(merged_results[map_type][planner][1] / map_counter[map_type]) + ",")
			outfile.write(str(merged_results[map_type][planner][2] / map_counter[map_type]) + "\n")
		outfile.write("\n");
	outfile.close()
