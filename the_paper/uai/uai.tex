...
state space, which is the type of planning problem our work addresess;
...
from following each algorithm's policy, but found that the difference
in accumulated reward across planners was negligible.
