...
on the path of the optimal policy.  
%\stnote{Need a sentence about why
...
\begin{tabular}{ l || c c | c c | c  c }
  ...
  \texttt{BREAD}  		&	16406		& 	962			& 	7738 	& 	809  		&	7412 	& 	{\bf 578}
\end{tabular}
}
...
We also collected data on the amount of accumulated reward that resulted
from following each algorithm's policy, but found that the differences
in accumulated reward between each planner to be negligible.
