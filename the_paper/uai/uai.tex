...
We conducted a series of experiments\footnote{We plan on releasing all of our on notification of acceptance.} in the Minecraft domain that
...
We set the reward function is $-1$ for all transitions, except
...
One of the most compelling results is that affordance-aware planners are capable of solving a variety of difficult tasks.
