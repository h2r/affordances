...
However, subgoal planning falls short in that sub-goals only go so far in directing the low-level planner. The planner will still waste many cycles searching through meaningless portions of the state-space. Additionally, the creation of useful subgoals is quite difficult - in many cases, subgoals must be crafted to a specific state-space and cannot generalize, or, alternatively, they are generalizable but are not useful. % Add more about these two problems.. See: problem_with_subgoals.txt
