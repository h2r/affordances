...
\begin{abstract}
% Concern: Our experiments all take advantage of the fact that if you place a block, your state space EXPLODES
% Our affordance model basically lets us say "don't place blocks unless you need to"
% Other models fail because of that.... Seems like we've set ourselves up too much.
