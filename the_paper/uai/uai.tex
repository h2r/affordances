...
%(and
%the API through which it is controlled) 
...
the agent's distance from a pit of lava, which is incuded in a number
of our planning problems.
%as well as the planning tasks
...
applications in robotic care-giver companions. \jmnote{I'm not sure this last sentence on extensions belongs here; maybe future work?}
