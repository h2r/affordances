...
results of the affordance aware subgoal planner. As expected, in the bread baking world the Subgoal planner did extremely well. This is due to the fact that this world leads to extremely effective and simple subgoals (ie. pick up grain, use oven).
...
current surroundings, and output a distribution over the agent's action set. This would allow an affordance
