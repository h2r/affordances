...
\includegraphics[width=0.5\linewidth]{figures/fig1_vi.png}}%
\subfigure[Planning with affordances.]{
\includegraphics[width=0.5\linewidth]{figures/fig1_aff.png}}%
...
\includegraphics[width=0.24\linewidth]{figures/epicworld_4.png}}%
  \caption{The affordance-aware subgoal planner solving an ore-smelting task: the agent had to jump over trenches,
  place blocks, destroy walls, mine gold ore, avoid lava, open a door, and finally smelt the gold in a furnace in order to achieve its goal. This task
...
\begin{tabular}{ l || c | c | c | c | c | c }
  & VI & RTDP & SG & A-VI & A-RTDP & A-SG \\
  \hline
  \texttt{4BRIDGE} 		&	71604 		& 836 		&		1373 	& {\bf 100}  	& 152 	& 141  \\
  \texttt{6BRIDGE} 		&	413559 	 	& 4561 		&		28185  	& {\bf 366}  	& 392 	& 547  \\
  \texttt{8BRIDGE} 		&	1439883 	 	& 18833. 		&		15583	& 904		& {\bf 788} 	& 1001 			\\
  \texttt{DOORB} 		&	861084 	 	& 12207 		&		6368		& 4368	 	& 1945  	& {\bf 1381}	\\
  \texttt{LAVAB}  		&	413559 	 	& 4425. 		&		25792	& 366	 	& 993  	& {\bf 597}\\
  \texttt{TUNNEL}  		&	203796 	 	& 26624		&		5404 	& {\bf 105}	 	& 145  	& 182	\\
  \texttt{BREAD}  		&	16406 		& 7738 		&		7412 	& 962		& 809  	& {\bf 578}
\end{tabular}
}

\caption{The number of state backups performed by each algorithm for a
  variety of tasks requiring block placement and destruction.
  Affordances dramatically improve performance. \label{table:blocks} }
\end{table}
...
\begin{tabular}{ l || c | c | c | c | c | c}
  & VI & RTDP & SG & A-VI & A-RTDP & A-SG \\
  \hline
  \texttt{10WORLD} 		&	{\bf 800}	& 1205 	&	1263		&	{\bf 800}	& 	985 		&	960	\\
  \texttt{15WORLD} 		&	3150		& 3939 	&	3328 	&	3150	 	& 	3089 	&	{\bf 2331} 	\\
  \texttt{20WORLD} 		&	7200		& 10719 	&	8738		&	7200		& 	8004 	&	{\bf 6099}	\\
  \texttt{DOOR}  		&	6315		& 5646 	&	4104 	&	6315	 	& 	4059 	&	{\bf 2886}	\\
  \texttt{JUMP}	  		&	2940		& 4313 	&	4262 	&	2940	 	& 	3548 	&	{\bf 2922} 	\\
  \texttt{MAZE}  			&	4266		& 5648	&	{\bf 1949}	&	4266		&	2864		&	3073	\\
  \texttt{LAVA} 			&	800		& 1328	&	1003 	&	800	 	& 	861 		&	{\bf 772}
\end{tabular}
}

\caption{The number of state backups performed by each algorithm for a
  variety of tasks without block placement and destruction actions.
  Here affordances have a diminished effect.\label{table:noblocks}}
...
affordances are specific to task types. The lifted goal description $g$ of
...
blocks multiple blocks along the trench, despite the fact that the agent already
constructed a bridge that affords passage across (i.e. these are not
...
\subsection{Affordances}
% Steedman
Mark Steedman performed work in formalizing affordances, where he proposed the Linear Dynamic Event Calculus (LDEC). His work was aimed at linking events and objects in the context of language and prelinguistic cognitive apparatuses ~\citep{steedman02}. Ashutosh Saxena and Hema Koppula recently developed an inference algorithm that enables a robotic agent to anticipate a human partner's actions based on the robots perceived affordances ~\citep{koppula13a}. Additionally, the same group performed work in predicting object affordances by treating humans as a latent variable in a given scene. ~\citep{koppula13c}. Peter Gorniak and Deb Roy have jointly done work with what they call the Affordance-Based-Concept (cite). Their work is targeted at
...
Gorniak's doctoral dissertation developed this theory, which is applied toward situated-language understanding and language-generating agents. ~\citep{gorniak05}. Lastly, many have used affordances as a paradigm for solving table top grasping problems ~\citep{pas13,sweeney07,detry09,montesano09}
...
strategies, including A* for use in a robotic-cooking companion, as well as enhancing POMDPs\footnote{a classical extension of the MDP in which the agent must make decisions with respect to a distribution over a {\it belief} state,
