...
% This equation doesn't seem quite right. I think it should be
% \sum_{i = 1}^2 \binom{10 \cdot 10}{i}. This is the total number
% of ways of placing the agent in the 10x10x2 world (no block), plus
% number of ways of placing the agent and one block.
\begin{equation}
